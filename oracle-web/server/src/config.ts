...
const configSchema = z.object({
  ...
  execution: z
    .object({
      ...
      momentum_enabled: z.boolean().default(true),
      momentum_min_move_pct: z.number().min(0).max(1).default(0.03),
      momentum_min_pullback_pct: z.number().min(0).max(1).default(0.015),
      momentum_volume_mult: z.number().positive().default(1.3),
